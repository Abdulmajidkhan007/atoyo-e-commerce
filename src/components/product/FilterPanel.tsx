  ...
  return (
    <aside className="flex w-full flex-col gap-4 rounded-xl2 border border-navy-100 bg-white p-4 dark:border-navy-500 dark:bg-navy-700 lg:w-64 lg:shrink-0">
      <div className="flex items-center justify-between">
        <h2 className="font-semibold text-navy-900 dark:text-white">Filtrlar</h2>
      ...
      <FormControl size="small" fullWidth>
        <InputLabel id="brand-label">Brend</InputLabel>
        <Select
          labelId="brand-label"
          label="Brend"
          value={filters.brand ?? ""}
      ...
      <FormControl size="small" fullWidth>
        <InputLabel id="country-label">Ishlab chiqaruvchi davlat</InputLabel>
        <Select
      ...
      <div>
        <p className="mb-1 text-sm text-navy-500 dark:text-navy-100">Narx oralig&apos;i (so&apos;m)</p>
        <div className="flex items-center gap-2">
          <TextField size="small" type="number" placeholder="Dan" value={minPrice} onChange={(e) => setMinPrice(e.target.value)} onBlur={applyPriceRange} />
          <TextField size="small" type="number" placeholder="Gacha" value={maxPrice} onChange={(e) => setMaxPrice(e.target.value)} onBlur={applyPriceRange} />
        </div>
      </div>
      ...
      <FormControl size="small" fullWidth>
        ...
        >
          ...
          <MenuItem value="price-asc">Narx: arzondan qimmatga</MenuItem>
          <MenuItem value="price-desc">Narx: qimmatdan arzonga</MenuItem>
        </Select>
      </FormControl>
    </aside>
  );
