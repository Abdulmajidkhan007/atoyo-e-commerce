    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-navy-300">
          ...
          orqali yuboriladi. Mijoz kalitni <code>/optom</code>{" "}
          sahifasida kiritsa, hisobi optomga o&apos;tadi va katalogda <b>optom narxlarni</b>{" "}
          ko&apos;radi. Dona mijozlar optom narxni ko&apos;rmaydi.
        </p>
      </div>
      <WholesalePanel />
    </div>
